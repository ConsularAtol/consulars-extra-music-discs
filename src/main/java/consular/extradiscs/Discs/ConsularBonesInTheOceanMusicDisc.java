...
public class ConsularBonesInTheOceanMusicDisc extends MusicDiscItem {
	public ConsularBonesInTheOceanMusicDisc() {
		super(0, (net.minecraft.sound.SoundEvent) ModSounds.CONSULAR_BONES_EVENT,
