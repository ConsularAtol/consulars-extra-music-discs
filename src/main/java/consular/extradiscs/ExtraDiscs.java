...
import consular.extradiscs.Discs.ConsularBonesInTheOceanMusicDisc;
...
public class ExtraDiscs implements ModInitializer {
	...
	//public static final Item Undertale_ITEM = Registry.register(Registry.ITEM, id("undertale_start"), new UndertaleStartMusicDisc());
	
	public static Item CONSULAR_BONES_ITEM = Registry.register(Registry.ITEM, id("consular_bones_in_the_ocean"), new ConsularBonesInTheOceanMusicDisc());;
