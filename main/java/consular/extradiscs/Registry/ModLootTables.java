...
public class ModLootTables {
    ...
    private static final Identifier SHIPWRECK_TABLE_ID = new Identifier("minecraft", "chests/shipwreck_map");
    ...
    public static void registerLootTables() {
        LootTableLoadingCallback.EVENT.register((ResourceManager, LootManager, id, Supplier, Setter) -> {
            //Puts all music discs that aren't considered rare in dunegons... very messily because I couldn't get the for loop to work.
            ...
            //Shipwreck time
            if (SHIPWRECK_TABLE_ID.equals(id)) {
                FabricLootPoolBuilder poolBuilder = FabricLootPoolBuilder.builder()
                    .rolls(ConstantLootNumberProvider.create(1))
                    .with(ItemEntry.builder(ExtraDiscs.CONSULAR_BONES_ITEM));
                    Supplier.withPool(poolBuilder.build());
            }
            //Desert temple time
